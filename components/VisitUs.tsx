          ...
          <div className="space-y-8">
            ...
            <div className="bg-coffee-900 p-8 rounded-3xl shadow-lg text-white">
              ...
              <div className="flex gap-4">
                <a href="https://www.instagram.com/_cafelolas" className="bg-white/10 p-4 rounded-2xl hover:bg-white/20 transition-all">
                  <Instagram size={24} />
                </a>
                <a href="https://web.facebook.com/profile.php?id=61558437200378" className="bg-white/10 p-4 rounded-2xl hover:bg-white/20 transition-all">
                  <Facebook size={24} />
                </a>
              </div>
            </div>
