...
import { Package, Clock, CheckCircle, XCircle, CreditCard, Banknote, FileText, X, MessageSquare, PhoneCall, Truck, Settings, Lock } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-4">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-6 py-3 bg-white border border-coffee-200 text-coffee-700 rounded-2xl font-bold hover:bg-coffee-50 transition-all shadow-sm"
            >
              <Settings size={20} />
              {showSettings ? 'Back to Orders' : 'Account Settings'}
            </button>
          </div>

          {showSettings ? (
            <div className="max-w-2xl mx-auto animate-fade-in">
              <div className="bg-white rounded-3xl shadow-sm border border-coffee-100 overflow-hidden p-8">
                <div className="flex items-center gap-3 mb-8">
                  <div className="w-12 h-12 bg-coffee-100 text-coffee-600 rounded-2xl flex items-center justify-center">
                    <Lock size={24} />
                  </div>
                  <div>
                    <h2 className="text-2xl font-serif font-bold text-coffee-900">Security Settings</h2>
                    <p className="text-coffee-600 text-sm">Update your password to keep your account secure.</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleUpdatePassword} className="space-y-6">
                  ...
                  {settingsSuccess && (
                    <div className="p-4 bg-emerald-50 border border-emerald-200 text-emerald-600 rounded-2xl text-sm flex items-center gap-2">
                      <CheckCircle size={18} />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-coffee-50 border border-coffee-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-coffee-500 text-coffee-900 transition-all"
                      placeholder="••••••••"
                    />
                  </div>

                  <div className="space-y-2">
                    <label className="text-sm font-bold text-coffee-700 ml-1">Confirm New Password</label>
                    <input
                      type="password"
                      required
                  ...
                  <button
                    ...
                    className="w-full bg-coffee-600 text-white font-bold py-4 rounded-2xl shadow-lg hover:bg-coffee-700 transform hover:-translate-y-0.5 transition-all disabled:opacity-50"
                  >
          ...
          <div className="relative bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden animate-fade-in-up">
            ...
            <div className="p-8 space-y-6 font-mono text-sm">
              ...
              <div className="text-center pt-6">
                ...
                <p className="text-[10px] text-slate-300">#2 Honradez Street Tugatog, Malabon, Philippines</p>
              </div>
            </div>
